...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var q, params, response, showData, filteredData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = term;
                    params = new URLSearchParams({ q: q });
                    return [4 /*yield*/, fetch("".concat(TVMAZE_BASE_URL, "/search/shows?").concat(params), {
                            method: "GET",
                        })];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    showData = (_a.sent());
                    filteredData = showData.map(function (show) {
                        var _a;
                        return ({
                            id: show.show.id,
                            name: show.show.name,
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, episodeData, filteredData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(TVMAZE_BASE_URL, "/shows/").concat(id, "/episodes"))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    episodeData = (_a.sent());
                    filteredData = episodeData.map(function (episode) { return ({
                        id: episode.id,
                        name: episode.name,
